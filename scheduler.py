...
def reschedule() -> None:
    ...
    for job_id in (JOB_ID, JOB_ID_META):
    ...
    if enabled:
        ...
        # Weekly retrospective, Sundays at the same time of day as the daily digest.
        ...
        logger.info("Daily digest scheduled at %02d:%02d; weekly meta-digest on Sundays", hour, minute)
    else:
